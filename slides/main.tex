...
\begin{frame}
    ...
    \begin{enumerate}
        \item Fortran / C / C++ --- static type AOT compiled languages
        \vspace{0.5em}
        \item MATLAB --- interpreter + precompiled Fortran binaries
        \vspace{0.5em}
        \item Python + NumPy + SciPy --- MATLAB within Python
        \vspace{0.5em}
        \item Julia --- rise of the JIT compilers
        \vspace{0.5em}
        \item Python + Numba --- Julia style computing in Python
        \vspace{0.5em}
        \item Python + JAX --- Parallelization, JIT and autodiff
    \end{enumerate}
